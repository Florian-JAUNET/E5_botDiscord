      ...
      if (command.userPerms || command.botPerms) {
        if (
          ...
          const userPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${message.author}, Vous n'avez pas les permissions \`${command.userPerms}\` pour utiliser cette commande !`
            )
            .setColor("Red");
        ...
        if (
          ...
          const botPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${message.author}, Je n'ai pas les autorisations \`${command.botPerms}\` pour utiliser cette commande !`
            )
            .setColor("Red");
