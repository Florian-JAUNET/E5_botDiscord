      ...
      if (slashCommand.userPerms || slashCommand.botPerms) {
        if (
          ...
          const userPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${interaction.user}, Vous n'avez pas les permissions \`${slashCommand.userPerms}\` pour utiliser cette commande !`
            )
            .setColor("Red");
        ...
        if (
          ...
          const botPerms = new EmbedBuilder()
            .setDescription(
              `🚫 ${interaction.user}, Je n'ai pas les autorisations \`${slashCommand.botPerms}\` pour utiliser cette commande !`
            )
            .setColor("Red");
